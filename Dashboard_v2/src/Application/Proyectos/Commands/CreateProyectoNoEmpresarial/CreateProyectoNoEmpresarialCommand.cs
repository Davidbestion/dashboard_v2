...
/// <summary>Crea un nuevo <see cref="Dashboard_v2.Domain.Entities.ProyectoNoEmpresarial"/>. Devuelve el ID generado.</summary>
public record CreateProyectoNoEmpresarialCommand : IRequest<(Result Result, string? Id)>, IProyectoCommand
{
...
/// <summary>Manejador de <see cref="CreateProyectoNoEmpresarialCommand"/>.</summary>
    ...
    : IRequestHandler<CreateProyectoNoEmpresarialCommand, (Result Result, string? Id)>
{
    ...
    public CreateProyectoNoEmpresarialCommandHandler(IApplicationDbContext context, IUser currentUser)
    {
        _context = context;
