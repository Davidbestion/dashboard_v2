...
/// <summary>Actualiza los campos de un <see cref="Dashboard_v2.Domain.Entities.ProyectoEmpresarial"/> existente.</summary>
public record UpdateProyectoEmpresarialCommand : IRequest<Result>, IProyectoCommand
{
...
/// <summary>Manejador de <see cref="UpdateProyectoEmpresarialCommand"/>.</summary>
    ...
    : IRequestHandler<UpdateProyectoEmpresarialCommand, Result>
{
    ...
    public UpdateProyectoEmpresarialCommandHandler(IApplicationDbContext context, IUser currentUser)
    {
        _context = context;
