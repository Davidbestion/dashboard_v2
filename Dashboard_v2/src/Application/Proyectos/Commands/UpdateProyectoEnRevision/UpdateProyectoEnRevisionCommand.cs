...
/// <summary>Actualiza los campos de un <see cref="Dashboard_v2.Domain.Entities.ProyectoEnRevision"/> existente.</summary>
public record UpdateProyectoEnRevisionCommand : IRequest<Result>, IProyectoCommand
{
...
/// <summary>Manejador de <see cref="UpdateProyectoEnRevisionCommand"/>.</summary>
