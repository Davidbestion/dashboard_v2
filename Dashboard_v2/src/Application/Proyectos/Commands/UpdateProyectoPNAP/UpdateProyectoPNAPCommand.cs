...
/// <summary>Actualiza los campos de un <see cref="Dashboard_v2.Domain.Entities.ProyectoPNAP"/> existente.</summary>
public record UpdateProyectoPNAPCommand : IRequest<Result>, IProyectoCommand
{
...
/// <summary>Manejador de <see cref="UpdateProyectoPNAPCommand"/>.</summary>
    ...
    : IRequestHandler<UpdateProyectoPNAPCommand, Result>
{
    ...
    public UpdateProyectoPNAPCommandHandler(IApplicationDbContext context, IUser currentUser)
    {
        _context = context;
